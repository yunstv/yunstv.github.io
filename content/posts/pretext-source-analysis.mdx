...
- 实时 Demo：[chenglou.me/pretext](https://chenglou.me/pretext/)
- 源码核心文件：[`src/layout.ts`](https://github.com/chenglou/pretext/blob/main/src/layout.ts) / [`src/measurement.ts`](https://github.com/chenglou/pretext/blob/main/src/measurement.ts) / [`src/line-break.ts`](https://github.com/chenglou/pretext/blob/main/src/line-break.ts)
- 前身项目：[Sebastian Markbage 的 text-layout](https://github.com/chenglou/text-layout)
- 相关概念：[layout thrashing on CSS-Tricks](https://css-tricks.com/forced-synchronous-layouts/)
