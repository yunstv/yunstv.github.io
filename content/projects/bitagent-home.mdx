...
featured: true
screenshots:
  - src: /projects/bitagent-home/home.jpg
    title: 首页 · Assembly of Synthetic Minds
    description: 协议主叙事开屏 + 入场动效（react-element-in-viewport 驱动）
    route: /
  - src: /projects/bitagent-home/about.jpg
    title: About · 协议总览
    description: Hero / Build / AIP / Vision / CTA 五段叙事
    route: /about
  - src: /projects/bitagent-home/skill.jpg
    title: Skill · 生态合作伙伴
    description: 38 个合作伙伴的分类色板 grid（数据驱动渲染）
    route: /skill
  - src: /projects/bitagent-home/login.jpg
    title: Login · 登录引导
    description: BackgroundGradient + ConnectButton 入口动效
    route: /login
  - src: /projects/bitagent-home/disclaimer.jpg
    title: Disclaimer · 法律声明
    description: HTML 正文与视图分离（content.ts）
    route: /disclaimer
---
