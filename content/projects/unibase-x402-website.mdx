...
featured: true
screenshots:
  - src: /projects/unibase-x402-website/home.jpg
    title: 首页 · x402 协议讲解
    description: 协议 v1/v2 API、Permit2 proxy、BNB Chain 合约地址、生态合作
    route: /
  - src: /projects/unibase-x402-website/xusd.jpg
    title: XUSD · Wrap / Unwrap dApp
    description: USDC ↔ XUSD 1:1 包装；两个 tab 共享 TokenSwapForm
    route: /xusd
---
